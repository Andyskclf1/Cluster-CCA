...
cluster_CCA = function( initial_partition = NULL , cluster_count ,
                         ...
                         center = T , tolerance = 0.0001 , verbose = F,
                         ALS_iteration_count = 100 , show_info = F)
{
  # Cluster-CCA for two-way data
  ...
  subject_count = nrow(data[[1]]) #total number of subjects in the data
  variable_count = ncol(data[[1]]) #number of variables in a block
