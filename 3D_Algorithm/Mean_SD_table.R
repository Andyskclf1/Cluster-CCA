...
mean_ari_by_subject_count = 
  aggregate(results_table$ari, list(subject_count = results_table$subject_count), 
            FUN = function(x) c(mn = mean(x), sd = sd(x) ))
mean_ari_by_variable_b_count = 
  aggregate(results_table$ari, list(results_table$variable_b_count), 
            FUN = function(x) c(mn = mean(x), sd = sd(x) ))
...
mean_tuckers_by_subject_count = 
  aggregate(results_table$tuckers, list(results_table$subject_count), 
            FUN = function(x) c(mn = mean(x), sd = sd(x) ))
mean_tuckers_by_variable_b_count = 
  aggregate(results_table$tuckers, list(results_table$variable_b_count), 
            FUN = function(x) c(mn = mean(x), sd = sd(x) ))
...
print(mean_ari_by_variable_b_count)
...
print(mean_tuckers_by_variable_b_count)
