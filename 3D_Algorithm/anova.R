...
results_table$variable_b_count = as.factor(results_table$variable_b_count)
...
anova_ari <- aov(
  ari ~ subject_count * variable_b_count * max_weight * 
  correlation * noise, 
  data = results_table,
  contrasts = list(
    subject_count = "contr.sum",
    variable_b_count = "contr.sum",
...
anova_tuckers <- aov(
  tuckers ~ subject_count * variable_b_count * max_weight * 
    correlation * noise, 
  data = results_table,
  contrasts = list(
    subject_count = "contr.sum",
